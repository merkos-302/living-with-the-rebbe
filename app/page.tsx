...
/**
 * Parse Page (Root/Home)
 *
 * Main interface for processing newsletters
 * This is the default page users land on when opening the app.
 *
 * Features:
 ...
 * - Authentication and admin permission enforcement
 *
 * Part of Phase 2 MVP - Admin UI implementation
 */

export default function ParsePage() {
  const { isLoading: authLoading, isAuthenticated, isAdmin, error, refreshUser } = useAuth();
  ...
  // User is authenticated and is an admin - show the parse page
  return (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <p className="text-sm text-gray-500">
              <strong>Note:</strong> Only linked documents (PDFs, Word files, etc.) will be uploaded
              to CMS. Inline images displayed in the email will remain as-is.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <p className="text-sm text-gray-600">
                Maintain exact HTML formatting and structure. Only URLs are replaced - everything
                else stays the same.
              </p>
            </div>
          </div>
